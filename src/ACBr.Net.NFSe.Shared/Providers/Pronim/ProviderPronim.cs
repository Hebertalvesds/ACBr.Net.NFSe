...
namespace ACBr.Net.NFSe.Providers.Pronim
{
    internal sealed class ProviderPronim : ProviderBase
    {
        ...
        public override RetornoWebservice Enviar(int lote, NotaFiscalCollection notas)
        {
            ...
            foreach (var nota in notas)
            {
                ...
                switch (Configuracoes.WebServices.Ambiente)
                {
                    //case DFeTipoAmbiente.Producao:
                    case DFeTipoAmbiente.Homologacao:
                        xmlRps = GetXmlRpsV2(nota, false, false, false);
                        break;
                    case DFeTipoAmbiente.Producao:
        ...
        /// <summary>
        /// Metódo de geração do XML do serviços do Pronim Primeira Versão Comum.
        /// </summary>
        ...
        private string GetXmlRps(NotaFiscal nota, bool identado, bool showDeclaration, bool withPrefix)
        {
            ...
            infoRps.RemoveAttributes();
            infoRps.AddAttribute(new XAttribute("Id", "RPS" + nota.IdentificacaoRps.Numero));
            rps.Add(infoRps);
            ...
            infoRps.AddChild(AdicionarTag(TipoCampo.DatHorTz, "", "DataEmissao", ns, 20, 20, Ocorrencia.Obrigatoria, nota.IdentificacaoRps.DataEmissao));
            infoRps.AddChild(AdicionarTag(TipoCampo.Int, "", "NaturezaOperacao", ns, 1, 1, Ocorrencia.Obrigatoria, exigibilidade));
            ...
            //valores.AddChild(AdicionarTag(TipoCampo.De2, "", "DescontoCondicionado", ns, 1, 15, Ocorrencia.NaoObrigatoria, nota.Servico.Valores.DescontoCondicionado));
        ...
        /// <summary>
        /// Metódo de geração do XML do serviços do Pronim Versão 2.02
        /// </summary>
        /// <param name="nota"></param>
        /// <param name="identado"></param>
        /// <param name="showDeclaration"></param>
        /// <param name="withPrefix"></param>
        /// <returns></returns>
        private string GetXmlRpsV2(NotaFiscal nota, bool identado, bool showDeclaration, bool withPrefix)
        {
            var incentivadorCultural = (nota.IncentivadorCultural == NFSeSimNao.Sim) ? 1 : 2;
            string tipoRps;
            switch (nota.IdentificacaoRps.Tipo)
