...
{
    internal sealed class ProviderGinfesV2 : ProviderBase
    {
        ...
        public override RetornoWebservice Enviar(int lote, NotaFiscalCollection notas)
        {
            ...
            xmlLote.Append("<EnviarLoteRpsEnvio xmlns:tipos=\"http://www.ginfes.com.br/tipos\" xmlns=\"http://www.ginfes.com.br/servico_enviar_lote_rps_envio\">");
        ...
        public override RetornoWebservice ConsultarLoteRps(int lote, string protocolo, NotaFiscalCollection notas)
        {
            ...
            // Verifica Schema
            ValidarSchema(retornoWebservice, "servico_consultar_lote_rps_envio_v02.xsd");
            if (retornoWebservice.Erros.Any()) return retornoWebservice;
        ...
        private IGinfesV2ServiceClient GetCliente(TipoUrl tipo)
        {
            switch (Configuracoes.WebServices.Ambiente)
            {
                case DFeTipoAmbiente.Homologacao:
                    return new GinfesV2HomoServiceClient(this, tipo);

                case DFeTipoAmbiente.Producao:
                    return new GinfesV2ProdServiceClient(this, tipo);
